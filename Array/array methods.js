...
//=====Methods===:
//Push and Pop:
let myFruits = ['Apple', 'Mango', 'Pineapple', 'Strawberry'];
myFruits[0] = "Banana";
...
let myCartoons = ['Ben 10', 'Chota Bheem', 'Tom and Jerry'];
...
console.log(myCartoons);
let allowedStudents = ['Ali', 'Abrar', 'Shahid', 'Nawaz', 'Daniyal', 'Ameen', 'extra'];
if (allowedStudents.length > 5) {
    allowedStudents.pop();
}
console.log(allowedStudents);
//Slice and Splice method:-
let myFriends = ['Hunain', 'Naji', 'Umar', 'Sheriyar', 'Anas', 'Hassam'];
...
let myGuests = ['Sohail', 'Sharjeel', 'Shaheen', 'Riaz', 'Abdullah', 'Sami'];
...
let myCar = ["Corolla", "Audi", "Mercedes", "Ferrari"];
...
let transportation = ["BMW's compact sedan. ", "Audi Q7.", "Honda Civic"];
...
let myFriends3 = ["Anas", "Moiz", "Hunain", "Umar", "Hassam", "Shery"];
