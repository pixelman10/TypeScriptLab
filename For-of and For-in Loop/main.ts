...
let studentdata:{name:string,age:number,isEnrolled:boolean,id:number,
...
let names:string[] = ["Ayan","Ayesh","Sohaib","Laraib"];
for(let i in names){   
...
let names1:string[] = ["Ayan","Ayesh","Sohaib","Laraib","Sameer"];
for(let s in names1){
...
let friend : {name:string,age:number,gender:string,qualification:string,
    adress:{country:string,city:string},[key:string]:any} = {
...
let friends:string[]=["Naji","Ahmed","Anas","Maheer","Moiz","Umar"];
...
let teachers: string[]=["Wasay","Raza","Rehmat","Rehman","Tayyab"];
