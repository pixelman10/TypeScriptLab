...
function logAndReturn <T> (value:T): T {  //it is basically
    return value;
}

let result:string = logAndReturn<string>("Hey")
console.log(result);
let result2:number = logAndReturn<number>(6)
console.log(result2);
...
function logAndReturn1 (value:string |number ): string | number {
    return value;
}
