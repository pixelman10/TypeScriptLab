...
let c = 9;
let d = 10;
let andOperator = (a > 0) && (b > 0) && (c > 0); //answer is true.           AIK bhi value yah condition false ho yeh answer false de dega .It is used tod first false value.
console.log(andOperator);
let andOperator2 = (a > 6) && (b > 0) && (c > 0); //answer is false.           AIK bhi value yah condition false ho yeh answer false de dega .It is used tod first false value.
console.log(andOperator2);
let orOperator = (a > 6) || (b > 6) || (c > 6); //answer is true.              AIK bhi value yah condition true ho yeh answer true de dega .It is used tod first true value. 
...
let cities = ["Karachi", "Paris", "Jaddah", "New jersey"];
cities.forEach(city => {
